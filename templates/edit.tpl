...
<div class="container">
  ...
  <form class="form-horizontal" action="edit.php" method="POST">
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="anme" placeholder="Enter name" value="{$users.name}" name="name">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="city" value="{$users.city}" placeholder="Enter city" name="city">
      </div>
    </div>
